...
def grab_commentid_list(stock_link):
    ...
    html = requests.get(f'https://api.pushshift.io/reddit/submission/comment_ids/l03p3x')
...
def get_comments(comment_list):
    ...
    html = requests.get(f'https://api.pushshift.io/reddit/comment/search?ids=gjrexsu&fields=body&size=1000')
...
if __name__ == "__main__":
    ...
    stock = grab_stock_count(stock_dict, comment_list)
